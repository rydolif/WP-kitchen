	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<a href="tel:<?php the_field('tel_url', 'option'); ?>" class="contacts__link contacts__phone" onclick="ym(46484835,'reachGoal','tel'); return true;">
					<?php the_field('tel', 'option'); ?>
				</a>
				<a href="mailto:<?php the_field('mail', 'option'); ?>" class="contacts__link" onclick="ym(46484835,'reachGoal','mail'); return true;">
